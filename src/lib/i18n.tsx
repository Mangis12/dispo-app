...
const RU: Record<string, string> = {
  ...
  // — Atleisti / Nereikalingi / dokumentų redagavimas —
  'Atleisti': 'Уволенные',
  'Atleistas nuo': 'Уволен с',
  'Grąžinti': 'Вернуть',
  'Grąžinti į aktyvius': 'Вернуть в активные',
  'Grąžinti į reikalingus': 'Вернуть в нужные',
  'Pažymėti nereikalingu': 'Отметить ненужным',
  'Nereikalingas': 'Ненужный',
  'Nereikalingi': 'Ненужные',
  'nereikalingas': 'ненужный',
  'aktyvus': 'активный',
  'atleistas': 'уволен',
  'grąžintas': 'возвращён',
  ...
  'Vėliau': 'Позже',
  'Rodyti visus': 'Показать всех',
  'Redaguoti datas': 'Редактировать даты',
  'Dokumentai atnaujinti': 'Документы обновлены',
  'Dokumentų datų nėra. Spauskite „Redaguoti" arba importuokite Excel.': 'Дат документов нет. Нажмите «Редактировать» или импортируйте Excel.',
  'Vairuotojas bus perkeltas į „Atleisti" skiltį ir nuimtas nuo mašinos. Vėliau jį galima grąžinti.': 'Водитель будет перемещён в раздел «Уволенные» и снят с машины. Позже его можно вернуть.',
  'Kūrėjas': 'Создатель',
