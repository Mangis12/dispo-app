...
const RU: Record<string, string> = {
  ...
  // — Priminimai / Alert —
  'Priminimai': 'Напоминания',
  'Mano priminimai': 'Мои напоминания',
  'Įspėjimai': 'Предупреждения',
  'Naujas priminimas': 'Новое напоминание',
  'Priminimų dar nėra': 'Напоминаний пока нет',
  'Priminti po savaitės': 'Напомнить через неделю',
  'suėjo': 'пора',
  'Priminimas išsaugotas': 'Напоминание сохранено',
  'Įjungti push pranešimus': 'Включить push-уведомления',
  'Push pranešimai įjungti': 'Push-уведомления включены',
  'Push pranešimai neleisti': 'Push-уведомления не разрешены',
  'Laisvas priminimas': 'Свободное напоминание',
  'Dokumentas': 'Документ',
  'Pavadinimas': 'Название',
  'Pastaba': 'Заметка',
  'Priminti': 'Напомнить',
  'Kaip dažnai': 'Как часто',
  'Vieną kartą': 'Один раз',
  'Kas savaitę': 'Каждую неделю',
  'Kas 2 savaites': 'Каждые 2 недели',
  'Kas mėnesį': 'Каждый месяц',
  'Įspėjimai · baigiasi dokumentai': 'Предупреждения · истекают документы',
  'Nėra vairuotojų su besibaigiančiais dokumentais': 'Нет водителей с истекающими документами',
  'Vairuotojai kadencijoje, kurių dokumentai baigiasi per 30 d.': 'Водители в рейсе, чьи документы истекают в течение 30 дн.',
  'Sukurti priminimą': 'Создать напоминание',
  'pasibaigė': 'истёк',
  'Atnaujinti dokumentą': 'Обновить документ',
  'Priminimas vairuotojui': 'Напоминание по водителю',
  'Priminimas mašinai': 'Напоминание по машине',
  'Priminimas': 'Напоминание',
  'neprivaloma': 'необязательно',
  'pvz. Paklausti, kada atvyks į kadenciją': 'напр. Спросить, когда прибудет на ротацию',
  'nebus iki kadencijos pabaigos, reikės kito vairuotojo': 'не дотянет до конца ротации, нужен другой водитель',
  'neišbus iki kadencijos pabaigos, reikės kito vairuotojo': 'не дотянет до конца ротации, нужен другой водитель',
  'Dokumentas baigsis iki kadencijos pabaigos — reikia kito vairuotojo': 'Документ истечёт до конца ротации — нужен другой водитель',
